...
2. Their settings page requires the relevant client mod loading properly, Recar settings are, however, external and separate. But you can still open them in Discord settings assuming the client mod loaded properly.
...
5. No global ringing popup and Recar Overlay, that's Recar special!!!
...
3. Again, no global ringing popup and Recar Overlay, that's Recar special!!!
